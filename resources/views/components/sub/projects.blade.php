<div id="projects" class="section-full p-t80 p-b50 square_shape2 mobile-page-padding our-project2-wrap">
    <div class="container">
        ...
        <!-- PORTFOLIO GRID -->
        <div class="section-content">
            <div class="row mfp-gallery product-stamp clearfix justify-content-center">
                @php
                    $projects = [
                        ...
                        ['image' => 'images/PP-6.jpeg', 'title' => 'Residential Driveway', 'category' => 'cat-2', 'tags' => 'Residential, Paving'],
                        ['image' => 'images/PP-7.jpeg', 'title' => 'Grass Track Driveway', 'category' => 'cat-4', 'tags' => 'Residential, Paving']
                    ];
                @endphp

                @foreach($projects as $project)
                    <div class="{{ $project['category'] }} col-lg-4 col-md-6 m-b30">
