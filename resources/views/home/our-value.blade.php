                    ...
                    <div class="row">
                        <div class="col-lg-7 col-md-12">
                            <div class="video-section-full-v2">
                                <div class="video-section-full bg-no-repeat bg-cover overlay-wraper m-b30"
                                    style="background-image:url(images/video-bg2.jpg)">
                        ...
                        <div class="col-lg-5 col-md-12">
                            ...
                            <div class="video-part-2">
                                <h3><span class="font-weight-100">We will provide</span> you the best work which you
                                    dreamt for!</h3>
                                <p>It is a long established fact that a reader will be distracted by the readable
                                    content of a page when looking at its layout.there are many variations of passages
                                    of Ipsum available,</p>
